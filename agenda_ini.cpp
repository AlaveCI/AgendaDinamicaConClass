...
public:
    ...
    void encontrar_nombre(string _dato_buscado){
        bool encontrado = false;
        Nodo* recorrido = inicio;
        while (recorrido != NULL)
        {
            if (recorrido->getDato().getNombre().find(_dato_buscado) != string::npos )
            {
                recorrido->imprimir();
                encontrado = true;
                cout<<"Coincidencias =>  "<< recorrido->getDato().getNombre()<<endl;
                recorrido = recorrido->getEnlace();
...
void MostrarMenu()
{
    ...
    cout << "9.- Buscar Coincidencias por  Letras  " << endl;
    cout << "0.- Salir" << endl;
}
...
int main()
{
    ...
    do
    {
        ...
        case 8:
            ...
            break;
        case 9:
            cout << "Ingrese las letras a  buscar " << endl;
            cin>>letra_buscadas;
            agenda.encontrar_nombre(letra_buscadas);
            break;
        default:
